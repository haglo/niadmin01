...
insert into neuro.sgigroup (uuidEntry, listPrio, entityValue) values (uuid(), 3, 'ni-extern');
insert into neuro.sgigroup (uuidEntry, listPrio, entityValue) values (uuid(), 4, 'ni-student');
