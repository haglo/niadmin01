...
public class LoginScreen extends FlexLayout {
    ...
    private AccessControl accessControlBasic;
    private AccessControl accessControlLdap;

    public LoginScreen() {
        accessControlBasic = AccessControlFactory.getInstance().createAccessControlBasic();
    ...
    private void login() {
        ...
        try {
            if (accessControlBasic.signIn(username.getValue(), password.getValue())) {
                getUI().get().navigate("");
            } 
